...
class ImportJobService
{
    ...
    CrawlJob[] importDirectory(String path) throws WaHarvesterException
    {
        ...
        try {
            ...
            Seedlist seedlist = parseSeedList(new File(jobDirectory + "seeds.txt"))
            CrawlJobReport report = parseCrawlReport(new File(jobDirectory + "crawl-report.txt"))

            job.directoryName = directory.getName()
            job.seedlist = seedlist
            job.report = report
