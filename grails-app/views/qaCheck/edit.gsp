...
<div class="body">
  ...
  <g:form method="post">
    ...
    <g:hiddenField name="version" value="${qaCheckInstance?.version}"/>
    <div class="dialog">
      <table>
        <tbody>
        ...
        <tr class="prop">
          <td valign="top" class="name">
            <label for="problems"><g:message code="qaCheck.problems.label" default="Problems"/></label>
          </td>
          <td valign="top" class="value ${hasErrors(bean: qaCheckInstance, field: 'problems', 'errors')}">
