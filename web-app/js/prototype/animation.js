...
YAHOO.util.Anim.prototype = {doMethod:function (attribute, start, end) {
...
}, defaultUnit:'px', defaultUnits:{opacity:' '}, init:function (el, attributes, duration, method) {
    ...
    this.stop = function () {
        ...
        this.currentFrame = 0;
        endTime = new Date();
        var data = {time:endTime, duration:endTime - startTime, frames:actualFrames, fps:actualFrames / this.duration};
        isAnimated = false;
        actualFrames = 0;
